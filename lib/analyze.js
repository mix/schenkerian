...
const CHEERIO_FIND_IMG_ELEMENT_PATHS = 'meta[property="og:image"], meta[property="twitter:image:src"], meta[name="twitter:image"], meta[name="twitter:image:src"]'
const CHEERIO_FIND_TITLE_ELEMENT_PATHS = 'meta[property="og:title"], meta[property="twitter:title"], meta[name="twitter:title"]'
...
function gatherMetaData(url, body) {
  ...
  .then(parsedBody => {
    ...
    let title
    cheerioBody.find(CHEERIO_FIND_TITLE_ELEMENT_PATHS).each((i, elem) => {
    ...
    let image
    cheerioBody.find(CHEERIO_FIND_IMG_ELEMENT_PATHS).each((i, elem) => {
